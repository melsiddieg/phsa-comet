<style>
    ...
    * { box-sizing: border-box; }
    ...
    header { background: var(--comet-brown); color: #F8EBD5; padding: 0.6rem 1.2rem; display: flex; flex-wrap: wrap; align-items: center; gap: 0.5rem 1.5rem; }
    header nav { flex-wrap: wrap; row-gap: 0.3rem; }
    header a, header button { white-space: nowrap; }
    header .account { margin-left: auto; display: flex; gap: 1rem; align-items: center; }
